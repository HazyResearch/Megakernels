...
def benchmark_causal_attention() -> None:
    print("Causal Attention (bf16, head_dim=128)")
    ...
    for batch, seq_len, num_heads in [
        ...
        mk_ms, pt_ms = benchmark(causal_attention, (q, k, v))

        flops = 2.0 * batch * num_heads * seq_len * seq_len * head_dim
